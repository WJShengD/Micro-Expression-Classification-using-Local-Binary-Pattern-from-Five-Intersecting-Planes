function Histogram = LBPFIP(VolData, FxRadius, FyRadius, TInterval, NeighborPoints, TimeLength, F_length,BorderLength, bBilinearInterpolation, Bincount, Code,XY)
...
FF=[[XY,-XY,F_length];[XY,XY,F_length];[-XY,XY,-F_length];[-XY,-XY,-F_length];[-XY,-XY,F_length];[-XY,XY,F_length];[XY,XY,-F_length];[XY,-XY,-F_length]];
...
if (Bincount == 0)
    ...
    Histogram = zeros(4, nDim);
else
    % uniform code
    Histogram = zeros(4, Bincount); % Bincount = 59;
end
        ...
        for yc = BorderLength + 1 : height - BorderLength
            ...
            for xc = BorderLength + 1 : width - BorderLength
                ...
                for ff =FF'
                    ...
                    CurrentVal=VolData(yc+aa, xc+bb,i+cc) ;
